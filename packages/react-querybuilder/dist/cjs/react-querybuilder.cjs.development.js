...
__export(src_exports, {
  ...
  useQueryBuilderQuery: () => useQueryBuilderQuery,
...
var useRQB_INTERNAL_QueryBuilderSelector = (0, import_react_redux.createSelectorHook)(QueryBuilderStateContext);
...
var getCompatContextProvider = (gccpProps) => {
  ...
  return (props) => {
    return /* @__PURE__ */ React6.createElement(QBContextWrapper, null, /* @__PURE__ */ React6.createElement(QBContextInner, { ...props }, props.children));
  };
};
...
var mergeClassnames = (...args) => {
  const joinClassnamesByName = (name) => (0, import_clsx.default)(args.map((c) => (0, import_clsx.default)(c?.[name])));
  return {
...
// src/utils/mergeTranslations.ts
var mergeTranslations = (base, ...otherTranslations) => (0, import_immer3.produce)(base, (draft) => {
...
var prepareRule = (rule, { idGenerator = generateID } = {}) => (0, import_immer4.produce)(rule, (draft) => {
  if (!draft.id) {
    draft.id = idGenerator();
  }
});
var prepareRuleGroup = (queryObject, { idGenerator = generateID } = {}) => (0, import_immer4.produce)(queryObject, (draft) => {
  if (!draft.id) {
    draft.id = idGenerator();
  }
...
} = {}) => (0, import_immer5.produce)(query, (draft) => {
...
var remove = (query, path) => {
  ...
  return (0, import_immer5.produce)(query, (draft) => {
...
var remapProperties = (obj, propertyMap, deleteRemappedProperties) => (0, import_immer6.produce)(obj, (draft) => {
...
// src/hooks/useMergedContext.ts
var nullComp = () => null;
var nullFwdComp = (0, import_react3.forwardRef)(nullComp);
var emptyObject = {};
var useMergedContext = ({
  ...
  const cc = (0, import_react3.useMemo)(
    () => mergeClassnames(
  ...
  const controlClassnames = (0, import_react3.useMemo)(
    () => ({
  ...
  const mergeControlElement = (0, import_react3.useCallback)(
  ...
  const controlElements = (0, import_react3.useMemo)(
    () => (
...
function useQueryBuilderSchema(props, setup) {
  ...
  const querySelector = (0, import_react4.useMemo)(() => getQuerySelectorById(qbId), [qbId]);
  const storeQuery = useQueryBuilderSelector(querySelector);
  const getQuery = (0, import_react4.useCallback)(
    () => querySelector(queryBuilderStore2.getState()),
    [queryBuilderStore2, querySelector]
  );
  const fallbackQuery = (0, import_react4.useMemo)(() => createRuleGroup(), [createRuleGroup]);
  ...
  const [initialQuery] = (0, import_react4.useState)(rootGroup);
  const rqbContext = (0, import_react4.useMemo)(
  ...
  const independentCombinators = (0, import_react4.useMemo)(() => isRuleGroupTypeIC(rootGroup), [rootGroup]);
  ...
  const hasRunMountQueryChange = (0, import_react4.useRef)(false);
  (0, import_react4.useEffect)(() => {
  ...
  const dispatchQuery = (0, import_react4.useCallback)(
    (newQuery) => {
      queryBuilderDispatch(
  ...
  const onGroupAdd = (0, import_react4.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
  ...
  const onPropChange = (0, import_react4.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (prop, value, path) => {
      const queryLocal = getQuerySelectorById(qbId)(queryBuilderStore2.getState());
      if (!queryLocal) return;
  ...
  const onRuleOrGroupRemove = (0, import_react4.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (path, context) => {
      const queryLocal = getQuerySelectorById(qbId)(queryBuilderStore2.getState());
      if (!queryLocal) return;
  ...
  const moveRule = (0, import_react4.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
  ...
  const { validationResult, validationMap } = (0, import_react4.useMemo)(() => {
...
var useQueryBuilderSetup = (props) => {
  const [qbId] = (0, import_react5.useState)(generateID);
  const {
  ...
  const [initialQueryProp] = (0, import_react5.useState)(props.query ?? props.defaultQuery);
  ...
  const defaultField = (0, import_react5.useMemo)(
    () => ({
  ...
  const fieldsProp = (0, import_react5.useMemo)(
  ...
  const fieldMap = (0, import_react5.useMemo)(() => {
  ...
  const combinators = (0, import_react5.useMemo)(
    () => toFullOptionList(combinatorsProp, baseCombinator),
    [baseCombinator, combinatorsProp]
  );
  const defaultOperator = (0, import_react5.useMemo)(
    () => ({
  ...
  const getOperatorsMain = (0, import_react5.useCallback)(
    (field, { fieldData }) => {
  ...
  const getRuleDefaultOperator = (0, import_react5.useCallback)(
    (field) => {
  ...
  const getValueEditorTypeMain = (0, import_react5.useCallback)(
  ...
  const getValueSourcesMain = (0, import_react5.useCallback)(
    (field, operator) => getValueSourcesUtil(fieldMap[field], operator, getValueSources),
    [fieldMap, getValueSources]
  );
  const getValuesMain = (0, import_react5.useCallback)(
    (field, operator, { fieldData }) => {
      if (fieldData?.values) {
  ...
  const getRuleDefaultValue = (0, import_react5.useCallback)(
    (r) => {
  ...
  const getInputTypeMain = (0, import_react5.useCallback)(
    (field, operator, { fieldData }) => {
      if (getInputType) {
  ...
  const createRule = (0, import_react5.useCallback)(() => {
    let field = "";
    const flds = fields;
  ...
  const createRuleGroup = (0, import_react5.useCallback)(
    (independentCombinators) => {
...
var useRule = (props) => {
  ...
  const rule = (0, import_react6.useMemo)(
    () => ruleProp ? ruleProp : {
      id,
  ...
  const generateOnChangeHandler = (0, import_react6.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (prop) => (value, _context) => {
      if (!disabled) {
  ...
  const cloneRule = (0, import_react6.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (_event, _context) => {
      if (!disabled) {
  ...
  const toggleLockRule = (0, import_react6.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (_event, _context) => {
  ...
  const removeRule = (0, import_react6.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (_event, _context) => {
      if (!disabled) {
        onRuleRemove(path);
  ...
  const shiftRuleUp = (0, import_react6.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (event, _context) => {
  ...
  const shiftRuleDown = (0, import_react6.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (event, _context) => {
  ...
  const valueSources = (0, import_react6.useMemo)(
  ...
  const valueEditorType = (0, import_react6.useMemo)(
  ...
  const valueEditorSeparator = (0, import_react6.useMemo)(
  ...
  const valueSourceOptions = (0, import_react6.useMemo)(
    () => valueSources.map((vs) => ({ name: vs, value: vs, label: vs })),
    [valueSources]
  );
  const validationResult = (0, import_react6.useMemo)(
  ...
  const validationClassName = (0, import_react6.useMemo)(
    () => getValidationClassNames(validationResult),
    [validationResult]
  );
  const fieldBasedClassName = (0, import_react6.useMemo)(() => fieldData?.className ?? "", [fieldData?.className]);
  const operatorBasedClassName = (0, import_react6.useMemo)(
...
var useRuleGroup = (props) => {
  ...
  const disabled = !!parentDisabled || !!disabledProp;
  const combinator = (0, import_react7.useMemo)(
  ...
  const ruleGroup = (0, import_react7.useMemo)(
  ...
  const onCombinatorChange = (0, import_react7.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (value, _context) => {
      if (!disabled) {
  ...
  const onIndependentCombinatorChange = (0, import_react7.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
  ...
  const onNotToggleChange = (0, import_react7.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (checked, _context) => {
      if (!disabled) {
  ...
  const addRule = (0, import_react7.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (_event, context) => {
      if (!disabled) {
  ...
  const addGroup = (0, import_react7.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (_event, context) => {
      if (!disabled) {
  ...
  const cloneGroup = (0, import_react7.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (_event, _context) => {
      if (!disabled) {
        const newPath = [...getParentPath(path), path[path.length - 1] + 1];
  ...
  const shiftGroupUp = (0, import_react7.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (event, _context) => {
      if (!disabled && !shiftUpDisabled) {
        moveRule(path, "up", event?.altKey);
  ...
  const shiftGroupDown = (0, import_react7.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (event, _context) => {
      if (!disabled && !shiftDownDisabled) {
        moveRule(path, "down", event?.altKey);
  ...
  const toggleLockGroup = (0, import_react7.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (_event, _context) => {
      onPropChange("disabled", !disabled, path);
    },
  ...
  const removeGroup = (0, import_react7.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (_event, _context) => {
      if (!disabled) {
        onGroupRemove(path);
  ...
  const validationResult = (0, import_react7.useMemo)(
    () => validationMap[id ?? /* istanbul ignore next */
    ""],
    [id, validationMap]
  );
  const validationClassName = (0, import_react7.useMemo)(
    () => getValidationClassNames(validationResult),
    [validationResult]
  );
  const combinatorBasedClassName = (0, import_react7.useMemo)(
    () => independentCombinators ? null : getOption(combinators, combinator)?.className ?? "",
    [combinator, combinators, independentCombinators]
  );
  const ruleGroupClassname = (0, import_react7.useMemo)(
    () => getRuleGroupClassname(ruleGroup),
    [getRuleGroupClassname, ruleGroup]
  );
  const outerClassName = (0, import_react7.useMemo)(
    () => (0, import_clsx4.clsx)(
      ruleGroupClassname,
  ...
  const pathsMemo = (0, import_react7.useMemo)(() => {
    const paths = [];
  ...
  const accessibleDescription = (0, import_react7.useMemo)(
...
var useSelectElementChangeHandler = (params) => {
  ...
  const selectElementChangeHandler = (0, import_react8.useMemo)(
...
var useStopEventPropagation = (method) => (0, import_react9.useCallback)(
  (event, context) => {
...
var useValueEditor = (props) => {
  ...
  const valueAsArray = (0, import_react10.useMemo)(() => toArray(value), [value]);
  const multiValueHandler = (0, import_react10.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (val, idx) => {
      const v = (0, import_immer7.produce)(valueAsArray, (va) => {
        va[idx] = parseNumber(val, { parseNumbers });
        if (idx === 0 && (operator === "between" || operator === "notBetween") && (va.length < 2 || typeof va[1] === "undefined")) {
...
var useValueSelector = (props) => {
  ...
  const val = (0, import_react11.useMemo)(() => multiple ? toArray(value) : value, [multiple, value]);
  return {
    /**
...
var QueryBuilderContext = (0, import_react12.createContext)({});
  ...
  (rg) => {
    ...
    return /* @__PURE__ */ React10.createElement(React10.Fragment, null, rg.ruleGroup.rules.map(
      (r, idx, { length: ruleArrayLength }) => {
        ...
        return /* @__PURE__ */ React10.createElement(import_react13.Fragment, { key }, typeof r === "string" ? /* @__PURE__ */ React10.createElement(
