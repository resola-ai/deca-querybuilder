 ...
 * returned as-is.
 */
declare const convertFromIC: <RG extends RuleGroupType = RuleGroupType<RuleType<string, string, any, string>, string>>(rg: RuleGroupTypeIC) => RG;
/**
 ...
 * returned as-is.
 */
declare const convertToIC: <RGIC extends RuleGroupTypeIC = RuleGroupTypeIC<RuleType<string, string, any, string>, string>>(rg: RuleGroupType) => RGIC;
/**
...
type GetCompatContextProviderProps = QueryBuilderContextProps<FullField, string>;
/**
...
declare const mergeTranslation: (el: keyof Translations, keyPropContextMap: Record<string, [ReactNode, ReactNode]>, finalize?: boolean) => {
    [x: string]: any;
} | undefined;
 ...
 * {@link FullOption}.
 */
declare const isFullOptionGroupArray: (arr: any) => arr is OptionGroup<FullOption>[];
/**
 * Gets the option from an {@link OptionList} with the given `name`. Handles
 * {@link Option} arrays as well as {@link OptionGroup} arrays.
 */
declare const getOption: <OptType extends Option = Option<string>>(arr: OptionList<OptType>, name: string) => OptType | undefined;
/**
 * Gets the first option from an {@link OptionList}.
 */
declare const getFirstOption: <Opt extends BaseOption>(arr?: FlexibleOptionGroup<Opt>[] | Opt[]) => GetOptionIdentifierType<Opt> | null;
/**
 ...
 */
declare const insert: <RG extends RuleGroupTypeAny>(query: RG, ruleOrGroup: RG | RuleType, path: number[], { combinators, combinatorPreceding, combinatorSucceeding, idGenerator, replace, }?: InsertOptions) => RG;
 ...
 */
declare const uniqOptList: <T extends BaseOption>(originalArray: FlexibleOptionList<T>) => OptionGroup<ToFullOption<T>>[] | WithUnknownIndex<BaseOption<string> & FullOption<string>>[];
...
type QueryBuilderProps<RG extends RuleGroupTypeAny, F extends FullField, O extends FullOperator, C extends FullCombinator> = RG extends RuleGroupType<infer R> | RuleGroupTypeIC<infer R> ? QueryBuilderContextProps<F, GetOptionIdentifierType<O>> & {
    ...
    options: MoveOptions, context?: any): RG | boolean;
    /**
 ...
 */
declare const QueryBuilderContext: react.Context<QueryBuilderContextType>;
...
type UseMergedContextReturn<F extends FullField = FullField, O extends string = string> = QueryBuilderContextProps<F, O> & {
    initialQuery?: RuleGroupTypeAny;
    qbId?: string;
} & {
 ...
 */
declare const useMergedContext: <F extends FullField = FullField<string, string, string, Option<string>, Option<string>>, O extends string = string>({ finalize, ...props }: UseMergedContextProps<F, O>) => UseMergedContextReturn<F, O>;

declare const preferProp: (def: boolean, prop?: boolean, context?: boolean) => boolean;
/**
...
declare const useQueryBuilder: <RG extends RuleGroupTypeAny, F extends FullField, O extends FullOperator, C extends FullCombinator>(props: QueryBuilderProps<RG, F, O, C>) => {
    actions: QueryActions;
    rootGroup: RuleGroupTypeAny<GetRuleTypeFromGroupWithFieldAndOperator<RG, F, O>>;
    rootGroupDisabled: boolean;
    queryDisabled: boolean;
    rqbContext: {
        initialQuery: RuleGroupType<GetRuleTypeFromGroupWithFieldAndOperator<RG, F, O>, string> | RuleGroupTypeIC<GetRuleTypeFromGroupWithFieldAndOperator<RG, F, O>, string>;
        controlElements: Partial<{
        ...
        }> & Required<type_fest.SetNonNullable<Partial<{
            actionElement: react.ComponentType<ActionProps>;
            addGroupAction: react.ComponentType<ActionWithRulesAndAddersProps> | null;
            addRuleAction: react.ComponentType<ActionWithRulesAndAddersProps> | null;
            cloneGroupAction: react.ComponentType<ActionWithRulesProps> | null;
            ...
            valueSelector: react.ComponentType<ValueSelectorProps>;
            valueSourceSelector: react.ComponentType<ValueSourceSelectorProps> | null;
        }>, "notToggle" | "dragHandle" | "valueSourceSelector" | "ruleGroup" | "rule" | "shiftActions" | "actionElement" | "addGroupAction" | "addRuleAction" | "cloneGroupAction" | "cloneRuleAction" | "combinatorSelector" | "fieldSelector" | "inlineCombinator" | "lockGroupAction" | "lockRuleAction" | "operatorSelector" | "removeGroupAction" | "removeRuleAction" | "valueEditor" | "valueSelector">>;
        enableMountQueryChange: boolean;
        controlClassnames: Partial<Classnames> & Classnames;
 ...
 */
declare const useQueryBuilderSetup: <RG extends RuleGroupTypeAny, F extends FullField, O extends FullOperator, C extends FullCombinator>(props: QueryBuilderProps<RG, F, O, C>) => {
    qbId: string;
 ...
 */
declare function useQueryBuilderSchema<RG extends RuleGroupTypeAny, F extends FullField, O extends FullOperator, C extends FullCombinator>(props: QueryBuilderProps<RG, F, O, C>, setup: ReturnType<typeof useQueryBuilderSetup<RG, F, O, C>>): {
    actions: QueryActions;
    rootGroup: RuleGroupTypeAny<GetRuleTypeFromGroupWithFieldAndOperator<RG, F, O>>;
    rootGroupDisabled: boolean;
    queryDisabled: boolean;
 ...
 */
declare const ValueSelector: <Opt extends FullOption = FullOption<string>>(props: ValueSelectorProps<Opt>) => react.JSX.Element;
...
declare const defaultControlElements: {
    ...
    combinatorSelector: <Opt extends FullOption = FullOption<string>>(props: ValueSelectorProps<Opt>) => react.JSX.Element;
    dragHandle: react.ForwardRefExoticComponent<DragHandleProps & react.RefAttributes<HTMLSpanElement>>;
    fieldSelector: <Opt extends FullOption = FullOption<string>>(props: ValueSelectorProps<Opt>) => react.JSX.Element;
    ...
    operatorSelector: <Opt extends FullOption = FullOption<string>>(props: ValueSelectorProps<Opt>) => react.JSX.Element;
    ...
    valueSelector: <Opt extends FullOption = FullOption<string>>(props: ValueSelectorProps<Opt>) => react.JSX.Element;
    valueSourceSelector: <Opt extends FullOption = FullOption<string>>(props: ValueSelectorProps<Opt>) => react.JSX.Element;
};
